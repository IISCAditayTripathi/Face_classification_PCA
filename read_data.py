...
class read_and_load(object):
    ...
    def make_train_test(self):
        ...
        train_data, train_mean, train_class = self.read_data(data_list[0:data_split])
        ...
        return (train_data, train_mean, train_class, validation_data, valid_mean, valid_class)
